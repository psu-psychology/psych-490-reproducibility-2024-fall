...
if (n_responses > 1) {
  survey_01_clean <- survey_01_clean[1:n_responses,]  
...
```{r fig-openness-dotplot, message=FALSE, fig.cap="Reponses to Openness to Revising One’s Viewpoint subscale questions from [@Krumrei-Mancuso2016-qm]", eval = params$make_plots}
# survey_01_clean[,2:6] |>
#   ggpairs()
# 
...
```{r fig-trust-dotplot, message=FALSE, fig.cap="Responses to trust in science questions from [@Nadelson2014-ym]", eval = params$make_plots}
...
```{r fig-openness-trust-composite, fig.cap="Composite 'openness' and 'trust' scores", eval = params$make_plots}
survey_01_recoded |>
