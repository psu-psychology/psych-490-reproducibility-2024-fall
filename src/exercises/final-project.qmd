...
- If the proposal is submitted on-time ([by Friday, October 18]{.orange_due}), the student or team gets 5 extra credit points. If the proposal is submitted late, there is no penalty, but also no extra points. If a student or team does not submit a proposal at all by Friday, November 1, there will be a five point penalty.

### Project presentation

- Every student or team may make an *optional* presentation to the class about their project. Please indicate whether you are willing to make a presentation when you complete the [survey](final-project.qmd#survey) below.
