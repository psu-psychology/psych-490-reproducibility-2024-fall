...
- @baker_1500_2016 survey on reproducibility in science
- According to @Nosek2022-hv
  - "*Reproducibility* refers to testing the reliability of a prior finding using the _____ data and the _____ analysis strategy..."
  - "_____ refers to testing the reliability of a prior finding with different data..."
...
flowchart TD
  A(hand-copy story) -->|+/-| B[moral purity]
  B -->|-/+| E[need to cleanse]
  E -->|+/-| C[desire for cleansing prods]
  C -->|+/-| D(rate prod desirability)
```
...
flowchart TD
  A(describe past deed) -->|+/-| B[moral purity]
  B -->|-/+| E[need to cleanse]
  E -->|+/-| C[desire for cleansing prods]
...
- Were the @Zhong2006-nf studies 1, 3, and 4 replicated by someone else?
