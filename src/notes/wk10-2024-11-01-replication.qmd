...
![Table 1 from @collaboration_estimating_2015](../include/img/collaboration-2015-table-01.png)

---

![Figure 1 from @collaboration_estimating_2015; Density plots of original and replication P values and effect sizes. (A) P values. (B) Effect sizes (correlation coefficients). Lowest quantiles for P values are not visible because they are clustered near zero.](../include/img/collaboration-2015-fig-01.JPEG)
...
![@collaboration_estimating_2015](https://www.science.org/cms/10.1126/science.aac4716/asset/82f22975-91c8-4779-865b-6ed0650601cd/assets/graphic/349_aac4716_fa.jpeg)
