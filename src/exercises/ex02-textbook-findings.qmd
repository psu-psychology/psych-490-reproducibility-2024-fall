...
Due: [Friday, September 20](../schedule.qmd#friday-september-20){.orange_due}.
...
1. Choose a finding from one of your psychology textbooks OR the paper you analyzed for [Exercise 01](ex01-read-a-scientific-paper.qmd).
2. If your source is a textbook, identify the primary citation or source for the claim. Find the cited paper, and use the rubric described in [@Carey2020-ut] to read the paper you chose.
...
5. Create a table summarizing the main claim(s), your evaluation about whether they are causal or descriptive^[2], and the evidence that supports them.
...
6. Look up your paper on Google Scholar. How many citations does the original paper have? How many of the citations to the original paper appear to be replication studies?
...
7. Does the original paper include shared data?
