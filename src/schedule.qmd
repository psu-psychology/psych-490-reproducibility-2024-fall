...
To earn 3 extra credit points for completing the survey, send the TA the date and time you completed the survey in the following format:
...
- [Assignment]{.green_assigned}
    - Complete (anonymous, extra credit) [survey](https://forms.gle/reRw9sYUzsYHUsqz9) on scientific norms and counter-norms. **No write-up**.
...
- [Final project survey]{.green_assigned}
    - Please complete the [final project survey](https://forms.gle/d4izA6vm3A1v5bqb6) by [Friday, November 15]{.orange_due}
...
- [[Final project survey](https://forms.gle/d4izA6vm3A1v5bqb6)]{.orange_due}
