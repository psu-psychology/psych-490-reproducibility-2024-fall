...
## "Logic" of the manipulation and measures

- Constructing sentences $\rightarrow$ primes polite/rude/neutral behavioral stereotypes
- Stereotypes $\rightarrow$ influence time to interrupt/likelihood of interrupting
...
#| fig-cap: "Visualization of Bargh @Bargh1996-yv Experiment 1 RT results; data from 13/34 participants who interrupted in 10 mins."
