...
>...There was evidence that both the violent content and the cue may have suppressed aggression among groups composed primarily of boys low in characteristic aggressiveness. Results were interpreted in terms of current information-processing theories of media effects on aggression. (PsycINFO Database Record (c) 2016 APA, all rights reserved)
...
- $aggrChar + violent + frustr + cue \rightarrow aggrObs$.

$b_1*charAggr + b_2*violent +...  = aggrObs + err$

- where the $b_i$ weight different variables to different extents
...
$$aggrChar + violent + cue > aggrChar + violent + noCue$$
